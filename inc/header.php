...
<head>
    ...
    <link href="../css/bootstraptheme-rtl.min.css" rel="stylesheet" />
...
<body class="bg-white">
    ...
    <div class="offcanvas offcanvas-top vh-100" id="searchBox" data-bs-backdrop="static" tabindex="-1" aria-modal="true" role="dialog" style="height: 100vh;">
        ...
        <div class="offcanvas-body d-flex justify-content-center align-items-center">
            <form class="container d-flex justify-content-center">
                <input type="search" class="form-control form-control-lg fs-lg border-0 border-bottom py-3 text-center mvtypewriterbold thaana"
                    placeholder="ހޯދާ" data-autofocus="offcanvas" style="max-width: 600px;">
            </form>
        </div>
    </div>
    ...
    <header class="navbar navbar-expand-lg bg-transparent z-fixed p-0">
        <div class="container py-3">
            ...
            <!-- Navbar brand (Logo) -->
            <a class="navbar-brand" href="/aasandhamv/dv/dhivehi.php">
            ...
            <div class="offcanvas offcanvas-end" id="navbarOffcanvas" tabindex="-1" aria-labelledby="navbarOffcanvasLabel">
                <div class="offcanvas-header">
                    <h5 class="offcanvas-title mvtypewriterbold text-dark" id="navbarOffcanvasLabel">މެނޫ</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                </div>
                <div class="offcanvas-body pt-0">
                    <ul class="navbar-nav ms-auto mvtypewriterbold">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                ކުންފުނި
                            </a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/aasandhamv/dv/dhivehi-about-us.php">ކުންފުނީގެ ތަޢާރަފް</a></li>
                                <li><a class="dropdown-item" href="/aasandhamv/dv/dhivehi-directors.php">ޑިރެކްޓަރުންގެ ބޯޑު</a></li>
                                <li><a class="dropdown-item" href="/aasandhamv/dv/dhivehi-administration.php">އެޑްމިނިސްޓްރޭޝަން</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/aasandhamv/dv/dhivehi-scheme.php">ސްކީމްތައް</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                ޓެންޑަރ
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropend">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="#">ވަޒީފާއަށް އެދޭ ފޯމް</a></li>
                                        <li><a class="dropdown-item" href="#">އިޢުލާން</a></li>
                                        <li><a class="dropdown-item" href="#">ޤާނޫނު</a></li>
                                        <li><a class="dropdown-item" href="#">ޤަވާޢިދު</a></li>
                                    </ul>
                                </li>
                                <li><a class="dropdown-item" href="#">އުސޫލު</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/aasandhamv/dv/dhivehi-downloads.php">ޑައުންލޯޑްސް</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                މީޑިއާ
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/aasandhamv/dv/dhivehi-gallery.php">ގެލެރީ</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/aasandhamv/dv/dhivehi-contact-us.php">ގުޅުއްވުމަށް</a>
                        </li>
                    </ul>
                </div>
            </div> <!--End Offcanvas -->
